...
contract DeployTransactionInclusionVerifier is Script {
    function run() external {
        ...
        console2.log(string(abi.encodePacked("  --constructor-args $(cast abi-encode \"constructor(address,address,bytes32)\" ", vm.toString(owner), " ", vm.toString(verifierAddress), " ", vm.toString(vkey), ") \\")));
        ...
        console2.log("  src/TransactionInclusionVerifier.sol:TransactionInclusionVerifier \\");
        console2.log("  --constructor-args $(cast abi-encode \"constructor(address,address,bytes32)\" $OWNER $SP1_VERIFIER $PROGRAM_VKEY) \\");
        console2.log("  --etherscan-api-key $ETHERSCAN_API_KEY \\");
        console2.log("  --watch");
    }
}
